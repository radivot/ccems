...
setwd("/users/radivot/case/active/ccems/ccems/inst/papers/TK2")  
load("data/TK2.rda")  
...
g=fitModel(g)
g$ciARD=reportg(g)
hwrite(g$ciARD,"outputs/ciARD12.html",cellspacing=0,cellpadding=2)
gARD=g
save(gARD,file="outputs/ARD12.RData")
